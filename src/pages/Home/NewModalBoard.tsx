...
export const NewModalBoard: React.FC<NewBoardModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSave = () => {
    ...
    if (boardName.trim() && boardNameRegex.test(boardName.trim())) {
      ...
      setError('Назва дошки може містити лише цифри, літери, пробіли, тире, крапки та нижні підкреслення.');
      console.log(error);
    }
  };
